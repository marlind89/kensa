...
public class Message extends TableImpl<MessageRecord> {
     ...
     */
    public final TableField<MessageRecord, String> AUTHOR = createField(DSL.name("author"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.message.text</code>.
     */
    public final TableField<MessageRecord, String> TEXT = createField(DSL.name("text"), SQLDataType.VARCHAR(4200).nullable(false), this, "");

    /**
     * The column <code>public.message.sent_at</code>.
     */
    public final TableField<MessageRecord, OffsetDateTime> SENT_AT = createField(DSL.name("sent_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
