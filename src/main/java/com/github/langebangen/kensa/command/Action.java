...
public enum Action
{
    ...
    PLAY("play", """
        Queues the specified song in the playlist from the specified URL. This play function supports streaming from several sites such
    ...
    LOOP("loop",
        "Enables/disables looping of the playlist. 'on' to enable looping and 'off' to disable it. Disabled by default."),
    ...
    INSULT("insult",
        "Insults the specified person. The person should be mentioned for this to work. Use !insult add to add an insult. " +
